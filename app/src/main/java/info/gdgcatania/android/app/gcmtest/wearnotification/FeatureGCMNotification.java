...
public class FeatureGCMNotification {
	...
	public static void notify(final Context context,
		...
		NotificationCompat.Builder featureBuilder = new NotificationCompat.Builder(
				context)
		...
		Notification featureNotify = new WearableNotifications.Builder(featureBuilder)
			.setHintHideIcon(true)
			.build();
		
		
		Notification mNoti=featureNotify;

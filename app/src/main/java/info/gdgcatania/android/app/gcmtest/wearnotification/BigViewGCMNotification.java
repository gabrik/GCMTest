...
public class BigViewGCMNotification {
	...
	public static void notify(final Context context,
		...
		String textBig = res.getString(R.string.text_bigView, exampleString);
		
		//creo un oggetto big text e gli passo il testo che deve fare vedere
		BigTextStyle big = new Notification.BigTextStyle();
		big.bigText(textBig);
		
		Notification.Builder bigViewBuilder = new Notification.Builder(
				context)
				.setDefaults(Notification.DEFAULT_SOUND)
				.setSmallIcon(R.drawable.ic_stat_gcm)
				.setContentTitle(title)
				.setContentText(textBig)
				//funziona solo con il Notification.Builder
				.setStyle(big)
		...
		Notification mNoti=bigViewBuilder.build();
